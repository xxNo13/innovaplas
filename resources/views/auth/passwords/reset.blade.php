...
@section('content')
    ...
    <div class="input-group input-group-alternative">
        ...
        <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" 
               ...
               value="{{ old('password') }}" 
               required>
        <i class="fa fa-eye position-absolute btn-password" style="right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
    </div>
...
<div class="form-group position-relative">
    <div class="input-group input-group-alternative">
        ...
        <input class="form-control" 
               ...
               required>
        <i class="fa fa-eye position-absolute btn-password" 
